    ...
    <div class="phone-viewport" v-cloak>
        ...
        <md-sidenav class="md-left" ref="nav" v-on:close="stationEditMode = false">
                        ...
                        <md-list>
                            <div v-if="stationEditMode">
                                <md-list-item class="md-inset"
                                              v-on:click="$refs.stationEditor.open()">
                            ...
                            <md-list-item v-if="!stationEditMode" class="md-inset"
                                          v-for="station in stream.stationList.arr"
                                          :key="station.id"
                                          :disabled="station.id === stream.currentStation.id"
            ...
            <md-list>
                ...
                <md-list-item class="md-primary">
                    ...
                    <md-list-expand>
                        <md-list>
                            <md-list-item class="md-inset" v-for="link in socialLinks"
                                          :key="link.name"
                ...
                <md-list-item v-if="shareSupported" v-on:click="openShareDialog()"
                              class="md-primary">
                    <md-icon>share</md-icon>
                    <span>Share</span>
                </md-list-item>
                <md-list-item v-on:click="$refs.nav.toggle()" :href="repoLink" class="md-primary"
                              target="_blank"
                              rel="noopener">
        ...
        <div id="streamCtrl">
            <md-button class="md-icon-button md-raised md-dense"
                       v-on:click="$refs.player.changeVolume(-0.1)"
            ...
            <md-button class="md-fab md-primary" :disabled="player.offline"
                ...
                <md-tooltip md-delay="400" md-direction="top">{{player.play ? "Pause" : "Play"}}
                </md-tooltip>
            </md-button>
        ...
        <md-snackbar ref="notification-bar" :md-position="notification.position"
                     :md-duration="notification.duration">
            <span>{{notification.message}}</span>
            <md-button v-if="notification.trigger" class="md-accent"
                       @click="notification.trigger.func">
...
<script>
  ...
  export default {
    ...
    methods: {
       ...
       * @param {Object} trigger - If set: trigger.text: Button text, trigger.func: Function for
       * button to trigger.
       * @returns {undefined}
       */

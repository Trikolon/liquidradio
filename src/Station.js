export default class Station {
   ...
   * @param {String} description - Further info about station shown in main view when station is
   * active.
   * @param {Array} source - Array containing info about audio stream source urls and type for
   * station.
   */
  ...
  set source(source) {
    ...
    for (let i = 0; i < source.length; i += 1) {
      if (!source[i].src || !source[i].type || source[i].src === '') {
